...
export interface ActiveCourse {
  ...
  file_preview_lines: FilePreviewLine[];
}
...
export interface ActivityItem {
  when: string;
  kind: "test_pass" | "test_fail" | "sub_done" | "module" | "resource" | "build";
  text: string;
  course: string;
}
...
export const ACTIVE: ActiveCourse = {
...
export const TODAY_DRILL: Drill = {
