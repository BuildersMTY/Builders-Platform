...
import type { ActiveCourse, Drill, Milestone } from "./data";

interface ContinueHeroProps {
  active: ActiveCourse;
}

export function ContinueHero({ active }: ContinueHeroProps) {
  return (
    <Link
      href="/workspace-v2"
      className="hero-card"
    ...
    >
      ...
      <div style={{ padding: "32px 36px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, color: "var(--text-dim)", fontSize: 12.5 }}>
          <LangBadge lang={active.lang} lang_label={active.lang_label} />
...
export function TodayDrillCard({ drill }: TodayDrillCardProps) {
  return (
    <div style={{
      padding: "20px 22px",
      border: "1px solid var(--border-strong)",
