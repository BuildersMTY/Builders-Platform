...
const { useState: uAState, useEffect: uAEff, useMemo: uAMemo } = React;
const { USER, ACTIVE, ENROLLED, TRACKS, TODAY_DRILL, ACTIVITY, BUILDS, MILESTONE, ACTIVITY_HEATMAP } = window.CoursesData;
const { TopNav } = window.CoursesNav;
const { ContinueHero, TodayDrillCard, MilestoneCard } = window.CoursesHero;
const { EnrolledCard, TrackRow, ActivityStream, BuildsList, ActivityHeatmap } = window.CoursesCatalog;
      ...
      {window.TweaksPanel && (
        <window.TweaksPanel title="Tweaks">
          <window.TweakSection label="Layout">
            ...
            <window.TweakToggle label="Show activity heatmap" value={tw.showActivityHeatmap}
              onChange={v => setTw("showActivityHeatmap", v)} />
          </window.TweakSection>
